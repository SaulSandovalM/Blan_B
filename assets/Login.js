...
authenticateUser = () => {
  ...
  handleLoginFinished = (error, result) => {
    ...
    <Image source={require('../imgs/fn.jpg')} style={{justifyContent: 'space-around', flex: 2, height: null, width: null, opacity: 15}}>

<Text style={{color: 'white', fontSize: 40, alignSelf: 'center', fontWeight: 'bold', marginTop: 20}}>BIENVENIDO</Text>
